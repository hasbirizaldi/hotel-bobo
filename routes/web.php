...
Route::post('/hotels/search/', [FrontController::class, 'search_hotels'])->name('front.search_hotels');
Route::get('/hotels/list/{keyword}', [FrontController::class, 'list_hotels'])->name('front.list_hotels');
Route::get('/hotels/details/{hotel:slug}', [FrontController::class, 'hotel_details'])->name('front.hotels.details');
Route::get('/hotels/details/{hotel:slug}/room', [FrontController::class, 'hotel_rooms'])->name('front.hotels.rooms');
...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('can:checkout hotels')->group(function(){
        ...
        Route::get('/book/finish/', [FrontController::class, 'hotel_book_finish'])->name('front.book.finish');

    });

    Route::middleware('can:checkout hotels')->group(function(){
        Route::get('/dashboard/my-bookings', [DashboardController::class, 'my_bookings'])->name('dashboard.my_bookings');
