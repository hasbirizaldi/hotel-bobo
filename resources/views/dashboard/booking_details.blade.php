...
<section id="content" class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#F8F8F8] overflow-x-hidden pb-[184px] relative">
    ...
    <div class="relative z-10 flex flex-col gap-6 mt-[60px]">
      <div class="top-menu flex justify-between items-center px-[18px]">
        <a href="{{ route('dashboard.my_bookings') }}" class="">
            ...
            <div id="Hotel-details" class="flex flex-col p-4 gap-4">
              <div class="flex items-center gap-3">
                ...
                <div class="flex flex-col gap-[2px]">
                  <p class="font-semibold text-sm leading-[21px] text-[#4041DA]">{{ $hotelBooking->checkin_at->format('d M Y') }} 
                    -
                    {{ $hotelBooking->checkout_at->format('d M Y') }}  ({{ $hotelBooking->total_day }} Night)</p>
            ...
            <div id="Reservation-details" class="flex flex-col p-4 gap-3">
              ...
              <div class="grid grid-cols-2 gap-3">
                <div class="flex flex-col gap-[6px]">
                  ...
                  <p class="font-semibold text-sm leading-[21px]">{{ $hotelBooking->checkin_at->format('d M Y') }}</p>
                ...
                <div class="flex flex-col gap-[6px] text-right">
                  ...
                  <p class="font-semibold text-sm leading-[21px]">{{ $hotelBooking->checkout_at->format('d M Y') }}</p>
