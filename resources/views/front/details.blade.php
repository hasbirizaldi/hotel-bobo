...
<section id="content" class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#F8F8F8] overflow-x-hidden pb-[122px] relative">
    ...
    <div id="Price-bar" class="fixed bottom-[24px] px-[18px] max-w-[640px] w-full z-30">
        ...
        <div class="price-info flex flex-row gap-[2px]">
            <p class="font-semibold text-lg leading-[27px] text-[#54A917]">Rp. {{ number_format($hotel->getLowestRoomPrice(), 0, ',', '.')  }}
            </p>
            <p class="font-semibold text-lg leading-[27px] text-[#757C98]">/Night</p>
        </div>
