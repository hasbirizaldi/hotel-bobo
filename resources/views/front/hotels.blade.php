...
@endif
      ...
      <form action="{{ route('front.search_hotels') }}" method="POST" class="bg-white p-4 flex flex-col gap-6 rounded-xl">
        @csrf
      ...
      <div class="bg-white p-[14px_12px] rounded-full flex items-center justify-center gap-8 shadow-[0_8px_30px_0_#0A093212]">
        <a href="{{ route('front.index') }}">
          <div class="flex flex-col gap-1 items-center">
            ...
            <p class="text-xs leading-[18px] font-medium text-[#757C98]">Home</p>
          </div>
        </a>
        <a href="{{ route('front.hotels') }}">
          <div class="flex flex-col gap-1 items-center">
            <div class="w-6 h-6 flex shrink-0">
              <img src="assets/images/icons/search-active.svg" alt="icon">
            </div>
            <p class="text-xs leading-[18px] font-semibold text-[#4041DA]">Search</p>
          </div>
        </a>
